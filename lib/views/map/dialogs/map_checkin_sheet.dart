    ...
    await showModalBottomSheet<void>(
      ...
      builder: (ctx) {
        ...
        return SafeArea(
          top: false,
          child: Padding(
            padding: EdgeInsets.only(bottom: mediaQuery.viewInsets.bottom + 12),
            child: Center(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SLSpacing.h8,
                      Text(
                        L10nService().format('p9_map_checkin_coordinates', {
                          'latitude': activePoint.latitude.toStringAsFixed(5),
                          'longitude': activePoint.longitude.toStringAsFixed(5),
                        }),
                        style: SLTheme.quicksand(
                          fontSize: 12,
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          onPressed: () async {
                            try {
                              final msgLimitFull = context.tr(
                                'map_ttia30vtrg_8875b5',
                              );
                              final nameTooLong = context.tr(
                                'p9_map_checkin_name_too_long',
                              );
                              final noteTooLong = context.tr(
                                'p9_map_checkin_note_too_long',
                              );
                              final pinSnapshot = await _mapPinLimitService
                                  .getSnapshot(widget.houseId);
                              final isCurrentPlaceAlreadyPinned = pinSnapshot
                                  .containsLocation(
                              ...
                              if (note.length > 300) {
                                throw Exception(noteTooLong);
                              }

                              final checkinRef = _dbRef
