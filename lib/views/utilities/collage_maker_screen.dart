...
class _CollageMakerScreenState extends State<CollageMakerScreen> {
  ...
  static const Duration _autoGenerateDebounceDuration = Duration(
    milliseconds: 360,
  );
  static final List<_CollageStylePreset> _stylePresets = [
    _CollageStylePreset(
      ...
      background: const Color(0xFFF4E6DE),
      minPhotos: 2,
      maxPhotos: 20,
    ),
    _CollageStylePreset(
      ...
      accent: const Color(0xFFB4895B),
      background: const Color(0xFFF7EEDD),
      minPhotos: 2,
      maxPhotos: 18,
    ),
    _CollageStylePreset(
      ...
      background: const Color(0xFFEEF3ED),
      minPhotos: 1,
      maxPhotos: 6,
    ),
    _CollageStylePreset(
      ...
      accent: const Color(0xFF5E7B72),
      background: const Color(0xFFE9F0EC),
      minPhotos: 1,
      maxPhotos: 8,
    ),
    _CollageStylePreset(
      ...
      accent: _paperCocoa,
      background: const Color(0xFFF5E8DB),
      minPhotos: 1,
      maxPhotos: 6,
    ),
    _CollageStylePreset(
      ...
      accent: const Color(0xFFC18B73),
      background: const Color(0xFFF7EBE3),
      minPhotos: 2,
      maxPhotos: 9,
    ),
    _CollageStylePreset(
      ...
      accent: const Color(0xFF9A6F74),
      background: const Color(0xFFF2E4E1),
      minPhotos: 3,
      maxPhotos: 40,
    ),
  ];
  ...
  static final List<_CollageBackgroundPreset> _backgroundPresets = [
    _CollageBackgroundPreset(
      ...
      accent: _paperRoseDeep,
      background: const Color(0xFFF7F0E6),
    ...
    _CollageBackgroundPreset(
      ...
      accent: const Color(0xFFC98FA1),
      background: const Color(0xFFF9E8EE),
      icon: Icons.cloud,
    ),
    _CollageBackgroundPreset(
      id: 'bogo_blue',
      ...
      accent: const Color(0xFF7FA9C8),
      background: const Color(0xFFE7F2FA),
    ...
    _CollageBackgroundPreset(
      ...
      accent: const Color(0xFFB991D8),
      background: const Color(0xFFF4EBFB),
  ...
  void dispose() {
    ...
    for (final image in _decodedImageCache.values) {
      try {
        ...
        debugPrint(
          '[SuppressedError] lib/views/utilities/collage_maker_screen.dart: $error',
        );
      }
    }
    _titleCtrl.dispose();
  ...
  CollageDecor _buildMemoryCollageDecor() {
    ...
    if (distinctDays.length == 1) {
      ...
      return CollageDecor.memory(
        occasionLabel: L10nService().format('util_collage_day_memory', {
    ...
    if (_selectedMonth != 'all') {
      return CollageDecor.memory(
        ...
        message: L10nService().format('util_collage_month_message', {
          'count': items.length,
        }),
      );
    }
  ...
  String _allMemoryPhotosLabel() => L10nService().format(
    'util_collage_all_memory_photos',
    {'count': _memoryPhotos.length},
  );

  String _monthMenuLabel(String key, int count) {
    final parts = key.split('-');
    if (parts.length != 2) {
      return L10nService().format('util_collage_key_count', {
        'key': key,
        'count': count,
      });
    }
  ...
  void _scheduleAutoGenerate({bool immediate = false}) {
    ...
    if (immediate) {
      ...
      _autoGenerateDebounceTimer = Timer(
        _autoGenerateDebounceDuration,
        trigger,
      );
    }
  }
  ...
  Future<ui.Image> _loadImage(
    ...
    if (source is String && source.startsWith('http')) {
      ...
      final image = await _decodeImageBytes(bytes, maxDimension: maxDimension);
      _cacheDecodedImage(cacheKey, image);
      return image;
    } else if (source is Uint8List) {
      return _decodeImageBytes(source, maxDimension: maxDimension);
    } else {
      ...
      final loaded = await Future.wait(
        batch.map((url) async {
          try {
            ...
            return await _loadImage(url, maxDimension: maxDimension);
          } catch (e) {
            debugPrint(
  ...
  Future<bool> _ensureFullQualityCollage() async {
    ...
    await _generateCollage(bypassDebounce: true, usePreviewQuality: false);
        ...
        final previewContent = Stack(
          children: [
            ...
            Positioned(
              ...
              child: Text(
                L10nService().format('util_collage_zoom_hint_title', {
                  'title': title,
                }),
                maxLines: 1,
                      ...
                      children: [
                        ...
                        TextField(
                          ...
                          decoration: InputDecoration(
                            hintText: L10nService().translate(
                              'util_vdnhngngyt_523bb0',
                            ),
                        ...
                        Text(
                          L10nService().translate(
                            'util_collage_title_hint_banner',
                          ),
                          style: SLTheme.quicksand(
                            fontSize: 12.5,
