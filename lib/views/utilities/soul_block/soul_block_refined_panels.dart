...
extension _SoulBlockRefinedPanels on _SoulBlockGameState {
                      ...
                      decoration: BoxDecoration(
                        ...
                        gradient: LinearGradient(
                          colors: <Color>[
                            ...
                            _kSoulPanelTop.withOpacity(0.22),
                        ...
                        border: Border.all(
                          color: _kSoulChrome.withOpacity(0.22),
                          width: 1.1,
                        ),
                        boxShadow: <BoxShadow>[
                          BoxShadow(
                            color: const Color(0xFF182B63).withOpacity(0.30),
                            blurRadius: 26,
                            spreadRadius: -10,
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                color: _kSoulChrome.withOpacity(0.34),
                                width: 1.1,
                              ),
                            ),
                            child: Row(
                    ...
                    AnimatedBuilder(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                          ...
                          boxShadow: <BoxShadow>[
                            BoxShadow(
                              color: const Color(0xFF15295F).withOpacity(0.38),
                              blurRadius: 28,
                              spreadRadius: -12,
                              offset: const Offset(0, 18),
                            ),
                      ...
                      decoration: BoxDecoration(
                        ...
                        gradient: LinearGradient(
                          colors: <Color>[
                            ...
                            _kSoulPanelBottom.withOpacity(0.94),
                          ],
                          begin: Alignment.topLeft,
                          end: Alignment.bottomRight,
                        ),
  ...
  Widget _buildRefinedMenuLoadingOverlay() {
    return IgnorePointer(
      child: DecoratedBox(
        decoration: BoxDecoration(
          color: const Color(0xCC12214A).withOpacity(0.74),
        ),
        child: Center(
          child: Container(
            width: 280,
            ...
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(
                colors: <Color>[
                  ...
                  _kSoulPanelTop.withOpacity(0.20),
                  _kSoulPanelBottom.withOpacity(0.96),
                ],
                begin: Alignment.topLeft,
                end: Alignment.bottomRight,
              ...
              border: Border.all(
                color: _kSoulChrome.withOpacity(0.30),
              ),
              boxShadow: <BoxShadow>[
                BoxShadow(
