              ...
              children: <Widget>[
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: _kSoulChrome.withOpacity(0.40),
                      width: 1.15,
                    ),
                    boxShadow: <BoxShadow>[
                      BoxShadow(
                        color: const Color(0xFF071226).withOpacity(0.18),
                        blurRadius: 14,
                        spreadRadius: -10,
  ...
  Widget _buildTrayPanel({bool compact = false}) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: _kSoulChrome.withOpacity(0.32),
          width: 1.0,
        ),
        boxShadow: <BoxShadow>[
          BoxShadow(
            color: const Color(0xFF071226).withOpacity(0.16),
            blurRadius: 12,
            spreadRadius: -8,
            ...
            children: <Widget>[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: <BoxShadow>[
                    BoxShadow(
                      color: const Color(0xFFFFC95D).withOpacity(0.20),
                      blurRadius: 8,
                      spreadRadius: -6,
                    ...
                    child: DecoratedBox(
                      decoration: BoxDecoration(
                        gradient: RadialGradient(
                          colors: <Color>[
                            Colors.white.withOpacity(isRecommended ? 0.10 : 0.05),
                            Colors.transparent,
                          ],
                          radius: 0.88,
