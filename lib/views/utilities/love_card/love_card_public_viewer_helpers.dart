    ...
    switch (key.trim().toLowerCase()) {
      case 'birthday':
        return _LoveCardViewerTheme(
          ...
          background: [const Color(0xFFFFC14F), const Color(0xFFF26A2E), const Color(0xFF7C2F27)],
          accent: const Color(0xFFE65A2C),
          envelope: const Color(0xFFFFE0AE),
          envelopeLight: const Color(0xFFFFF1D6),
          paper: const Color(0xFFFFFCF7),
          ink: const Color(0xFF6A3422),
          muted: const Color(0xFF95624F),
      ...
      case 'anniversary':
        return _LoveCardViewerTheme(
          ...
          background: [const Color(0xFF92E7FF), const Color(0xFF2F80ED), const Color(0xFF203E82)],
          accent: const Color(0xFF2E7FDF),
          envelope: const Color(0xFFCFEFFF),
          envelopeLight: const Color(0xFFF1FAFF),
          paper: const Color(0xFFF9FCFF),
          ink: const Color(0xFF24456C),
          muted: const Color(0xFF5E7EA6),
      ...
      case 'miss':
        return _LoveCardViewerTheme(
          ...
          background: [const Color(0xFFA7B2FF), const Color(0xFF6A5AF9), const Color(0xFF30275E)],
          accent: const Color(0xFF6659E8),
          envelope: const Color(0xFFD8D8FF),
          envelopeLight: const Color(0xFFF2F0FF),
          paper: const Color(0xFFFCFBFF),
          ink: const Color(0xFF3E356D),
          muted: const Color(0xFF71689F),
      ...
      default:
        return _LoveCardViewerTheme(
          ...
          background: [const Color(0xFFFF9CBC), const Color(0xFF8A2387), const Color(0xFF4E214F)],
          accent: const Color(0xFFD94777),
          envelope: const Color(0xFFFFD3E1),
          envelopeLight: const Color(0xFFFFEFF5),
          paper: const Color(0xFFFFFBFE),
          ink: const Color(0xFF5B3147),
          muted: const Color(0xFF8A6A7B),
