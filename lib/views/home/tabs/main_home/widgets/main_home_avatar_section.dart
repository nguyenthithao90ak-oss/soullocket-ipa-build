    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: UiPrefs.notifier.value.transparentMode
            ? []
            : [
                // Web: box-shadow: 0 8px 20px rgba(37,99,235,0.16) — alt: rgba(216,27,96,0.16)
                BoxShadow(
                  color: (isAlt
      ...
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          // Web: .love-time-value — font-size:28px, font-weight:900, tabular-nums
          Text(
            value,
            style: SLTheme.quicksand(
              fontSize: 22,
          ...
          SLSpacing.h4,
          // Web: .love-time-label — font-size:11px, font-weight:800, letter-spacing:0.8px, uppercase
          Text(
            label.toUpperCase(),
            style: SLTheme.quicksand(
              fontSize: 10,
