...
extension BackgroundEditorExt on _CountdownModeEditorScreenState {
  List<Widget> _buildEditorBackground(BuildContext context, _CountdownModeThemeData themeData) {
    return [
      _sectionCard(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _CountdownModeSheetDropdown(
                                  ...
                                  value: _styleKey,
                                  options: _CountdownModeEditorScreenState._countdownStyleOptions.map((entry) {
