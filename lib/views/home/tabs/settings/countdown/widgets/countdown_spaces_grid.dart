...
extension CountdownSpacesGridExt on _CountdownModeIndependentScreenState {
  Widget _buildAddSpaceTile(_CountdownModeThemeData themeData) {
    ...
    final accent = _hasReachedSpaceLimit
        ? const Color(0xFFE27A66)
        : themeData.orbA;

    return Semantics(
      button: true,
      enabled: !_isAddingSpace,
      child: InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: RadialGradient(
                      colors: [
                        accent.withValues(
                          alpha: themeData.isDark ? 0.16 : 0.18,
                        ),
                    ...
                    gradient: RadialGradient(
                      colors: [
                        themeData.orbB.withValues(
                          alpha: themeData.isDark ? 0.14 : 0.16,
                        ),
                      ...
                      child: Container(
                        ...
                        child: Text(
                          context
                              ...
                              .replaceAll(
                                '{count}',
                                _CountdownModeIndependentScreenState._maxSpaces
                                    .toString(),
                              ),
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    boxShadow: [
                                      BoxShadow(
                                        color: accent.withValues(
                                          alpha: themeData.isDark ? 0.20 : 0.18,
                                        ),
                                        blurRadius: 20,
  ...
  Widget _buildSpaceTile({
    ...
    return Semantics(
      button: true,
      enabled: !isHandlingIncomingRequest,
      hint: context.tr('p7_space_tile_hint'),
      child: InkWell(
              ...
              Expanded(
                child: LayoutBuilder(
                  builder: (context, previewConstraints) {
                    ...
                    final rawSize = widthSize < heightSize
                        ? widthSize
                        : heightSize;
                                  ...
                                  child: Container(
                                    ...
                                    child: ShaderMask(
                                      shaderCallback: (bounds) =>
                                          LinearGradient(
                                            colors:
                                                previewStyleData.numberGradient,
                                            begin: Alignment.topLeft,
                                            end: Alignment.bottomRight,
                                          ).createShader(bounds),
                                      child: FittedBox(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: RadialGradient(
                  colors: [
                    themeData.orbB.withValues(
                      alpha: themeData.isDark ? 0.22 : 0.28,
                    ),
          ...
          child: IgnorePointer(
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: RadialGradient(
                  colors: [
                    themeData.orbA.withValues(
                      alpha: themeData.isDark ? 0.18 : 0.24,
                    ),
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: RadialGradient(
                  colors: [
                    themeData.orbB.withValues(
                      alpha: themeData.isDark ? 0.10 : 0.14,
                    ),
                    Colors.transparent,
                  ],
                ),
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Tooltip(
                          message: context.tr('p7_private_info'),
                          excludeFromSemantics: true,
                          child: Semantics(
                            button: true,
                            label: context.tr('p7_private_info'),
                            excludeSemantics: true,
                            child: Material(
                              color: Colors.transparent,
                              shape: const CircleBorder(),
                              child: InkWell(
                                onTap: () =>
                                    _showPairingInfoBottomSheet(themeData),
                                customBorder: const CircleBorder(),
                                child: Container(
                                  width: 38,
                                  height: 38,
                        ...
                        builder: (context, constraints) {
                          ...
                          return GridView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final incomingRequest = _incomingRequestFor(
                                houseId,
                              );
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            context.tr('p7_private_info_title'),
                            style: SLTheme.quicksand(
                              fontSize: 20,
                              fontWeight: FontWeight.w900,
                              color: titleColor,
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Tooltip(
                              message: context.tr('p7_copy_house_code'),
                              excludeFromSemantics: true,
                              child: Semantics(
                                button: true,
                                label: context.tr('p7_copy_house_code'),
                                excludeSemantics: true,
                                child: InkWell(
                                  onTap: () async {
                                    final copiedMessage = context.tr(
                                      'p7_house_code_copied',
                                    );
                      ...
                      Text(
                        context
                            ...
                            .replaceAll(
                              '{count}',
                              _incomingSpaceRequests.length.toString(),
                            ),
                        style: SLTheme.quicksand(
                          fontSize: 13,
                          fontWeight: FontWeight.w900,
                        ...
                        ConstrainedBox(
                          ...
                          child: ListView.separated(
                            ...
                            separatorBuilder: (_, _) =>
                                const SizedBox(height: 10),
                            itemBuilder: (context, index) {
                              final request = _incomingSpaceRequests.values
                                  .elementAt(index);
                              final senderLabel =
                                  request.fromHouseName.trim().isNotEmpty
                                  ? request.fromHouseName.trim()
                                  : context.tr('p7_anonymous_house');

                              final requestId = request.requestId;
                              final isActionBusy = _spaceRequestActionIds
                                  .contains(requestId);
