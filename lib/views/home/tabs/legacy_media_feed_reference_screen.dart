...
part 'legacy_media_feed_reference_effects.dart';

/// ============================================================
///  LegacyMediaFeedReferenceScreen — Bản feed cũ để tham chiếu
///  Không còn là entry chính của app
/// ============================================================
class LegacyMediaFeedReferenceScreen extends StatefulWidget {
  ...
  const LegacyMediaFeedReferenceScreen({
    super.key,
  ...
  @override
  State<LegacyMediaFeedReferenceScreen> createState() =>
      _LegacyMediaFeedReferenceScreenState();
}

class _LegacyMediaFeedReferenceScreenState
    extends State<LegacyMediaFeedReferenceScreen> {
            ...
            Builder(builder: (context) {
              ...
              return PageView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return _LegacyMediaFeedReferencePostCard(
                    key: ValueKey(
