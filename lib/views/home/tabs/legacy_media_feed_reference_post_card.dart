...
class _LegacyMediaFeedReferencePostCard extends StatefulWidget {
  ...
  const _LegacyMediaFeedReferencePostCard({
    super.key,
    required this.post,
  ...
  @override
  State<_LegacyMediaFeedReferencePostCard> createState() =>
      _LegacyMediaFeedReferencePostCardState();
}

class _LegacyMediaFeedReferencePostCardState
    extends State<_LegacyMediaFeedReferencePostCard>
  ...
  void didUpdateWidget(
    covariant _LegacyMediaFeedReferencePostCard oldWidget,
  ) {
