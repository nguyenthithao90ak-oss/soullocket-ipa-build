...
final Map<String, _LoveThemeData> _loveCardThemes = {
  ...
  'encouragement': const _LoveThemeData(
    key: 'encouragement',
    chip: 'Động viên',
    title: 'Gửi lời động viên',
    subtitle: 'Tiếp thêm sức mạnh cho người ấy',
    signature: 'Luôn ủng hộ em!',
    effectLabel: '✨ Tia sáng động lực',
    icon: Icons.emoji_objects_rounded,
    accentIcon: Icons.whatshot_rounded,
    colors: [0xFFFF6B6B, 0xFFFECB6E],
    suggestions: [
      'Cố lên nhé, anh/em luôn ở đây vì em/anh!',
      'Anh/em làm được mà! Tin vào bản thân nhé.',
      'Dù thế nào thì anh/em cũng tự hào về em/anh.',
    ],
  ),
  'gratitude': const _LoveThemeData(
    key: 'gratitude',
    chip: 'Cảm ơn',
    title: 'Lời cảm ơn chân thành',
    subtitle: 'Biết ơn vì có nhau trong đời',
    signature: 'Mãi biết ơn!',
    effectLabel: '🌊 Sóng biển ân tình',
    icon: Icons.volunteer_activism_rounded,
    accentIcon: Icons.favorite_rounded,
    colors: [0xFF4FACFE, 0xFF00F2FE],
    suggestions: [
      'Cảm ơn em/anh vì tất cả những điều tuyệt vời!',
      'Có em/anh là điều may mắn nhất cuộc đời anh/em.',
      'Biết ơn từng khoảnh khắc bên nhau.',
    ],
  ),
  'adventure': const _LoveThemeData(
    key: 'adventure',
    chip: 'Phiêu lưu',
    title: 'Cùng nhau khám phá',
    subtitle: 'Những chuyến đi và kỷ niệm mới',
    signature: 'Cùng xê dịch!',
    effectLabel: '🏔️ Gió mây ngàn',
    icon: Icons.explore_rounded,
    accentIcon: Icons.flight_rounded,
    colors: [0xFF11998E, 0xFF38EF7D],
    suggestions: [
      'Đi thôi! Cùng nhau khám phá thế giới nhé!',
      'Chuyến phiêu lưu tiếp theo của đôi mình sẽ là đâu?',
      'Có em/anh ở cạnh, đi đâu cũng là thiên đường.',
    ],
  ),
  'serenity': const _LoveThemeData(
    key: 'serenity',
    chip: 'An nhiên',
    title: 'Khoảnh khắc bình yên',
    subtitle: 'Những giây phút nhẹ nhàng bên nhau',
    signature: 'An nhiên tự tại!',
    effectLabel: '🌙 Đêm trăng thanh',
    icon: Icons.self_improvement_rounded,
    accentIcon: Icons.nights_stay_rounded,
    colors: [0xFFA18CD1, 0xFFFBC2EB],
    suggestions: [
      'Ngồi bên nhau nghe nhạc, chẳng cần nói gì cũng vui.',
      'Bình yên nhất là khi có em/anh trong vòng tay.',
      'Hãy để những lo toan tan biến, chỉ còn đôi mình.',
    ],
  ),
};
