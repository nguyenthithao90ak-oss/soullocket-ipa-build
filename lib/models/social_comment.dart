...
Object? _readAuthorName(Map map, String key) => map['author'] ?? map['name'] ?? map['u'] ?? '';
...
class SocialComment {
  ...
  factory SocialComment.fromJson(Map<dynamic, dynamic> json) => _$SocialCommentFromJson(Map<String, dynamic>.from(json));
